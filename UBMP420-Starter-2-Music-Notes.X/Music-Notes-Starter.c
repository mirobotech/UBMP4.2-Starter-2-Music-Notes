/*==============================================================================
 Project: Music-Notes-Starter           Activity: mirobo.tech/ubmp4-starter-2
 Date:    July 5, 2023
 
 This starter programming project for the mirobo.tech UBMP4 leads you through
 a progression of code and functions for making music note frequencies. Refer
 to the Google Sheet linked below for pre-calculated period and cycle values:
...
// Music note 1/2 period delay in microseconds (us)
#define C5Period    956
#define C6Period    478
